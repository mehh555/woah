...
namespace Woah.Api.Migrations
{
    ...
    [Migration("20260323110755_PlayerPlaylistAndFeatCleaner")]
    partial class PlayerPlaylistAndFeatCleaner
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Woah.Api.Infrastructure.Persistence.Models.PlaylistTrackEntity", b =>
                {
                    ...
                    b.Property<Guid>("AddedByPlayerId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("PlaylistId", "ItunesTrackId")
                        .IsUnique();
            ...
            modelBuilder.Entity("Woah.Api.Infrastructure.Persistence.Models.LobbyEntity", b =>
                {
                    b.HasOne("Woah.Api.Infrastructure.Persistence.Models.PlaylistEntity", "ActivePlaylist")
                        .WithMany()
                        .HasForeignKey("ActivePlaylistId")
            ...
            modelBuilder.Entity("Woah.Api.Infrastructure.Persistence.Models.PlaylistTrackEntity", b =>
                {
                    b.HasOne("Woah.Api.Infrastructure.Persistence.Models.PlayerEntity", "AddedByPlayer")
                        .WithMany()
